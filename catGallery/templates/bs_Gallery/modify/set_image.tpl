...
<form action="{$CAT_URL}/modules/cc_catgallery/save.php" method="post" class="ajaxForm">
	...
	<p class="cc_catG_dreispalten">
		...
		<input type="text" class="cc_In100px" name="resize_x" value="{if $options.resize_x}{$options.resize_x}{else}675{/if}" /> px<br/>
		<span class="cc_In200px">{translate('Adjust vertical')}:</span>
		<input type="text" class="cc_In100px" name="resize_y" value="{if $options.resize_y}{$options.resize_y}{else}450{/if}" /> px<br/>
	</p>
