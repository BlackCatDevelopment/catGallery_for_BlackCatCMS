...
<div class="cc_catG_form" id="cc_catG_{$gallery_id}">
	...
	<h3 class="fc_gradient_red center"><br>{translate('The images are always grouped according to the category title. The categories are also automatically sorted alphabetically.')}<br><br></h3>
