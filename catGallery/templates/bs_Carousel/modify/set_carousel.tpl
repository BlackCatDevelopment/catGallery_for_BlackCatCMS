...
<form action="{$CAT_URL}/modules/cc_catgallery/save.php" method="post" class="ajaxForm">
	...
	<p class="cc_In300px">
		...
		<label for="cfade_{$section_id}">{translate('Activate fade')}:</label>
	</p>
	<br />
	<p class="cc_In300px">
		...
		<label for="cindicators_{$section_id}">{translate('Show indicators')}:</label>
	</p>
	<br />
	<p class="cc_In300px">
		...
		<label for="ititle_{$section_id}">{translate('Show image title')}:</label>
	</p>
	<br />
	<p class="cc_In300px">
		...
		<label for="icontent_{$section_id}">{translate('Show image description')}:</label>
	</p>
	<br />
