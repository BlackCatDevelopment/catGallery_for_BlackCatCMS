...
// --- hugeSlider ---
$LANG = [
    "For perfect result use in a template with full width or in a block with full width." =>
        "F&uuml;r das beste Ergebnis, eignet sich ein Template mit voller Breite bzw. ein Block mit voller Breite.",
