...
$LANG = [
    ...
    "For perfect result set height and width in image option to the same value." =>
        'F&uuml;r ein gutes Ergebnis setze die H&ouml;he und Breite unter "Bildoptionen" gleich.',
];
